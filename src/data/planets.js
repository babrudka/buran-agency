...
export const planets = [
...

    {
        ...
        tourDescs: [
            'Юпитер поражает масштабом. С наблюдательной станции открывается вид на гигантские штормы и знаменитое Большое красное пятно.'
        ],
...

    {
        ...
        tourDescs: [
            'Прогулка среди колец Сатурна — одно из самых красивых путешествий в космосе. Миллиарды ледяных частиц отражают свет далёкого Солнца.'
        ],
...

    {
        ...
        tourDescs: [
            'На далёком ледяном гиганте происходят процессы, которые могут превращать углерод в кристаллы.',
            'Этот тур посвящён редкой космической тишине. Медленные облака Урана создают спокойные голубые узоры.'
        ],
...

    {
        ...
        tours: ['Синий предел'],
        tourDescs: [
            'Самая далёкая экспедиция солнечной системы. Нептун встречает путешественников глубоким синим цветом атмосферы и мощными ветрами.'
        ],
