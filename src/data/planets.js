...
export const moon = {
    ...
    details: {
        area: '37.9 млн км²',
        atmosphere: 'Практически отсутствует: очень разреженная экзосфера из гелия, неона, аргона, следов водорода и натрия.',
        composition: 'Каменно-металлическое тело: силикатная кора и мантия, небольшое железосодержащее ядро.',
        gravity: '1.62 м/с² (около 16.5% земной).',
        temperatureRange: 'Примерно от -173°C ночью до +127°C днем (в полярных тенях до ~-249°C).',
...
export const planets = [
    {
        ...
        details: {
            area: '74.8 млн км²',
            atmosphere: 'Крайне разреженная экзосфера: кислород, натрий, водород, гелий, калий (следовые количества).',
            composition: 'Каменная планета с очень крупным железо-никелевым ядром и тонкой силикатной мантией/корой.',
            gravity: '3.7 м/с² (около 38% земной).',
            temperatureRange: 'Примерно от -180°C до +430°C.',
...

    {
        ...
        details: {
            area: '460.2 млн км²',
            atmosphere: 'Около 96.5% CO2 и 3.5% N2, облака серной кислоты и следы SO2, Ar, H2O.',
            composition: 'Каменная планета: силикатная кора и мантия, металлическое (железо-никелевое) ядро.',
            gravity: '8.87 м/с² (около 90% земной).',
            temperatureRange: 'Обычно около +460...+480°C у поверхности (почти без суточных колебаний).',
...

    {
        ...
        details: {
            area: '510.1 млн км²',
            atmosphere: 'Около 78% N2, 21% O2, ~0.93% Ar, ~0.04% CO2, переменный водяной пар.',
            composition: 'Каменная планета: силикатная кора/мантия, жидкое внешнее и твердое внутреннее железное ядро.',
            gravity: '9.81 м/с².',
            temperatureRange: 'От ~-89°C до ~+56°C у поверхности (рекордные наблюдения).',
...

    {
        ...
        details: {
            area: '144.8 млн км²',
            atmosphere: 'Тонкая: ~95% CO2, ~2.7% N2, ~1.6% Ar, следы O2, CO и водяного пара.',
            composition: 'Каменная планета с базальтовой корой, силикатной мантией и железо-сернистым ядром.',
            gravity: '3.71 м/с² (около 38% земной).',
            temperatureRange: 'Примерно от -125°C до +20°C.',
...

    {
        ...
        details: {
            ...
            atmosphere: 'Преимущественно H2 и He, есть примеси CH4, NH3, H2O, H2S и других газов.',
            composition: 'Газовый гигант: внешние молекулярные слои H2/He, глубокий слой металлического водорода, вероятное ядро из тяжелых элементов.',
            gravity: '24.79 м/с² (примерно 2.53 g на уровне 1 bar).',
            temperatureRange: 'Около -145°C в верхних облаках до тысяч °C в глубоких слоях.',
...

    {
        ...
        details: {
            ...
            atmosphere: 'Преимущественно H2 и He, есть CH4, NH3, следы H2O и других соединений.',
            composition: 'Газовый гигант: водородно-гелиевые слои, глубже металлический водород, в центре плотное ядро из тяжелых элементов.',
            gravity: '10.44 м/с² (около 1.06 g на уровне 1 bar).',
            temperatureRange: 'Около -178°C в верхних облаках; в глубине температура резко растет до тысяч °C.',
...

    {
        ...
        details: {
            ...
            atmosphere: 'H2 и He с долей CH4; метан поглощает красный свет и дает голубой оттенок.',
            composition: 'Ледяной гигант: каменное ядро, мантия из «льдов» (H2O, NH3, CH4) и внешняя газовая оболочка.',
            gravity: '8.69 м/с² (около 0.89 g).',
            temperatureRange: 'Примерно от -224°C (минимумы) до ~-197°C в верхних слоях.',
...

    {
        ...
        details: {
            ...
            atmosphere: 'H2 и He, заметная доля CH4; присутствуют следы углеводородов и других соединений.',
            composition: 'Ледяной гигант: каменно-ледяное ядро, мантия из воды/аммиака/метана и внешняя газовая оболочка.',
            gravity: '11.15 м/с² (около 1.14 g).',
            temperatureRange: 'Около -214°C в верхних облаках; глубже температура значительно выше.',
...

    {
        ...
        details: {
            area: '17.7 млн км²',
            atmosphere: 'Очень разреженная и сезонная: в основном N2, также CH4 и CO.',
            composition: 'Смесь льдов (азот, метан, CO) и каменно-ледяного недра с возможным подповерхностным океаном.',
            gravity: '0.62 м/с² (около 6.3% земной).',
            temperatureRange: 'Примерно от -240°C до -218°C.',
