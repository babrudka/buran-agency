...
// Углы линий туров в зависимости от количества
const TOUR_ANGLES = {
	1: [40],
	2: [0, 140],
}
...
export default function TourLines({ tours, planetId, size, onTourClick }) {
	// Массив смещений для покачивания каждого тура
	...
	useEffect(() => {
		...
		let step = 0
		// Каждый тур покачивается с разным сдвигом фазы
	...
	return (
		<AnimatePresence mode='wait'>
			...
			{tours.map((name, i) => {
				...
				// Конец линии — дальше от планеты + покачивание
				...
				const tagWidth = Math.round(size * 0.35)
